...
// Testet die Berechnung der Länge eines Vektors (2D)
TEST(VECTOR, Length2df1) {
  Vector2df vector = {6.0, 0.0};
  
  EXPECT_NEAR(6.0, vector.length(), 0.00001);
}

// Testet die Berechnung der Länge eines Vektors (3D)
TEST(VECTOR, Length3df2) {
  Vector3df vector = {0.0, 10.0, 0.0};
  
  EXPECT_NEAR(10.0, vector.length(), 0.00001);
}

// Testet die Berechnung des Quadrats der Länge eines Vektors (2D)
TEST(VECTOR, SquareOfLength2df1) {
  Vector2df vector = {9.0, 4.0};
  
  EXPECT_NEAR(97.0, vector.square_of_length(), 0.00001);
}

// Testet die Berechnung des Quadrats der Länge eines Vektors (3D)
TEST(VECTOR, SquareOfLength3df2) {
  Vector3df vector = {10.0, 10.0, 10.0};
  
  EXPECT_NEAR(300.0, vector.square_of_length(), 0.00001);
}

// Testet das Skalarprodukt von zwei Vektoren (2D)
TEST(VECTOR, ScalarProduct2df1) {
  Vector2df vector1 = {1.0, 2.0};
  Vector2df vector2 = {3.0, 4.0};
  
  float result = vector1 * vector2;
  
  EXPECT_NEAR(11.0, result, 0.00001);
}

// Testet das Skalarprodukt von zwei Vektoren (3D)
TEST(VECTOR, ScalarProduct3df2) {
  Vector3df vector1 = {1.0, 2.0, 3.0};
  Vector3df vector2 = {4.0, 5.0, 6.0};
  
  float result = vector1 * vector2;
  
  EXPECT_NEAR(32.0, result, 0.00001);
}
}
